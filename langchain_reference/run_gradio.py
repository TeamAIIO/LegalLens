...
# os.environ['OPENAI_API_KEY'] # 제공받은 키 입력

def get_vector_store(which_db):
...
def get_retriever_text(message, which_db):
    vector_store = get_vector_store(which_db)
...
def chat_interface(message, history):
    response = get_retriever_text(message, 'faiss')
    return response
